...
|---|---:|---:|---:|---:|---:|---:|---:|
| line_count | 4.5 | 0.5 | 0.25 | 4 | 4.5 | 4.95 | 5 |
| block_count | 2.5 | 0.5 | 0.25 | 2 | 2.5 | 2.95 | 3 |
...
| text_mask_ratio | 0.00131697 | 0.000119157 | 1.41984e-08 | 0.00119781 | 0.00131697 | 0.00142421 | 0.00143613 |
...
| rotation_deg | -0.644025 | 0.448874 | 0.201488 | -1.0929 | -0.644025 | -0.240038 | -0.195151 |

## Categorical diversity

| Field | Unique | Entropy bits | Top counts |
|---|---:|---:|---|
| layout_type | 2 | 1 | `{"mixed_cols": 1, "double_col": 1}` |
| density_level | 1 | 0 | `{"sparse": 2}` |
| noise_level | 1 | 0 | `{"clean": 2}` |
| scale_profile | 2 | 1 | `{"dpi200": 1, "dpi300": 1}` |
| page_family | 1 | 0 | `{"worksheet": 2}` |
| dominant_script | 2 | 1 | `{"unknown": 1, "latin": 1}` |
| has_table | 1 | 0 | `{"0": 2}` |
...
|---|---:|---:|---|
| layout_type × noise_level | 2 | 1 | `{"mixed_cols × clean": 1, "double_col × clean": 1}` |
| density_level × has_table | 1 | 0 | `{"sparse × 0": 2}` |
| density_level × has_equation | 1 | 0 | `{"sparse × 0": 2}` |
| layout_type × has_table | 2 | 1 | `{"mixed_cols × 0": 1, "double_col × 0": 1}` |
| has_table × has_equation | 1 | 0 | `{"0 × 0": 2}` |
| dominant_script × has_equation | 2 | 1 | `{"unknown × 0": 1, "latin × 0": 1}` |
...
| info | target_vs_observed:layout_type | `double_col` is over-produced; signed gap=0.240. | Adjust the config distribution for `layout_type` or inspect generation/QC constraints. |
