...
|---|---:|---:|---:|---:|---:|---:|---:|
| line_count | 27.5 | 6.5 | 42.25 | 21 | 27.5 | 33.35 | 34 |
| block_count | 8 | 1 | 1 | 7 | 8 | 8.9 | 9 |
...
| text_mask_ratio | 0.00830572 | 0.00224748 | 5.05115e-06 | 0.00605825 | 0.00830572 | 0.0103285 | 0.0105532 |
...
| rotation_deg | -0.501229 | 0.447876 | 0.200593 | -0.949105 | -0.501229 | -0.09814 | -0.0533523 |

## Categorical diversity

| Field | Unique | Entropy bits | Top counts |
|---|---:|---:|---|
| layout_type | 1 | 0 | `{"single_col": 2}` |
| density_level | 1 | 0 | `{"sparse": 2}` |
| noise_level | 1 | 0 | `{"medium": 2}` |
| scale_profile | 1 | 0 | `{"dpi300": 2}` |
| page_family | 2 | 1 | `{"book": 1, "notes": 1}` |
...
|---|---:|---:|---|
| layout_type × noise_level | 1 | 0 | `{"single_col × medium": 2}` |
| density_level × has_table | 1 | 0 | `{"sparse × 0": 2}` |
| density_level × has_equation | 1 | 0 | `{"sparse × 0": 2}` |
| layout_type × has_table | 1 | 0 | `{"single_col × 0": 2}` |
