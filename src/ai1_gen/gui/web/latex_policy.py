# src/ai1_gen/gui/web/latex_policy.py
...
from ai1_gen.gui.shared.override_utils import normalize_content_mix
from ai1_gen.gui.web.live_events import append_gui_event, safe_notify
...
def prepare_latex_or_fallback(
    ...
    try:
        from ai1_gen.latex.http_render import (
