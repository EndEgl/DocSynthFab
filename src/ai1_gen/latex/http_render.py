# src/ai1_gen/latex/http_render.py
...
# - Existing Docker container name: ai1_gen_latex_renderer
...
def _latex_lock_name_for_base_url(base_url: str) -> str:
    ...
    return f"ai1_gen_latex_renderer_{digest}.lock"
...
def latex_render_process_lock(
    *,
    ...
    Why this exists:
    - AI1 Gen can run multiple page workers.
    ...
    lock_dir = Path(tempfile.gettempdir()) / "ai1_gen_locks"
