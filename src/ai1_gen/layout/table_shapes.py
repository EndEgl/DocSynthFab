# src/ai1_gen/layout/table_shapes.py
    ...
    *,
    ...
    table_profiles: Dict[str, List[Dict[str, object]]] = {
        "worksheet": [
            ...
            {"kind": "blank_grid", "cols": (4, 9), "rows": (6, 16), "w": 0.24},
        ],
        "academic": [
    ...
    cols = rng.randint(int(col_range[0]), int(col_range[1]))
    rows = rng.randint(int(row_range[0]), int(row_range[1]))
    ...
    empty_cell_prob = max(0.0, min(0.70, base_empty_prob * table_empty_cell_scale))
