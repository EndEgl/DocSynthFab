# src/docsynthfab/cli/run_loop.py
...
from docsynthfab.io.exporter import save_json
from docsynthfab.telemetry.progress import ProgressPrinter, TemperatureReader, TelemetryError
